...
```{r}
splineDesign(c(rep(range(inner_knots), 3), inner_knots), inner_knots)
```
...
## Implementation: usage of the smoother (vizualisation)
...
## Error between the smoother and the original wave (vizualisation)
